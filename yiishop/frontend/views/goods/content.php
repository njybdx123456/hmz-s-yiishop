...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="/index/index"><img src="<?php Yii::getAlias('@web') ?>/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
										...
										<dl class="dl_1st">
											...
											<dd>
												<?php foreach ($children->child as $child):?>
													<a href="/goods/index?id=<?=$child->id?>"><?=$child->name?></a>
												<?php endforeach;?>
											</dd>
										</dl>
									<?php endforeach;?>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/index/index">首页</a></h2>
		</div>
		<!-- 面包屑导航 end -->
